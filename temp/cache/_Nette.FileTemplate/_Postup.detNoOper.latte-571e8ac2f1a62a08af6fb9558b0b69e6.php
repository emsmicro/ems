<?php //netteCache[01]000392a:2:{s:4:"time";s:21:"0.07243900 1363095450";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:70:"C:\xamlite\htdocs\ems\app\modules\Tpv\templates\Postup\detNoOper.latte";i:2;i:1363095447;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"f38d86f released on 2011-08-24";}}}?><?php

// source file: C:\xamlite\htdocs\ems\app\modules\Tpv\templates\Postup\detNoOper.latte

?><?php list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'a8uu29tmll')
;
// snippets support
...
<a href="<?php echo Nette\Templating\DefaultHelpers::escapeHtml($control->link("Operace:tcalc", array($item->id, $item->id_tpostup))) ?>
">&nbsp;&nbsp;&nbsp;&nbsp;</a><?php endif ?>
</span>
<?php endif ?>
	</td>
...
<a href="<?php echo Nette\Templating\DefaultHelpers::escapeHtml($control->link("Operace:edit", array($item->id, $item->id_tpostup))) ?>
">&nbsp;&nbsp;&nbsp;&nbsp;</a><?php endif ?>
</span>
		<span class="setdel" title="Odstranit"><?php if ($user->isAllowed('Operace','delete')): ?>
<a href="<?php echo Nette\Templating\DefaultHelpers::escapeHtml($control->link("Operace:delete", array($item->id, $item->id_tpostup))) ?>
">&nbsp;&nbsp;&nbsp;&nbsp;</a><?php endif ?>
</span>
	</td>
<?php endif ?>
