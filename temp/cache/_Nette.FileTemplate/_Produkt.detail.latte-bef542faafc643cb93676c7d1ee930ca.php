<?php //netteCache[01]000391a:2:{s:4:"time";s:21:"0.23860100 1382281597";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:69:"C:\xampp\htdocs\ems\app\modules\Obchod\templates\Produkt\detail.latte";i:2;i:1361466367;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"f38d86f released on 2011-08-24";}}}?><?php

// source file: C:\xampp\htdocs\ems\app\modules\Obchod\templates\Produkt\detail.latte

?><?php list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'cw11558fxg')
;//
// block drobecky3
//
if (!function_exists($_l->blocks['drobecky3'][] = '_lb2b6510b75c_drobecky3')) { function _lb2b6510b75c_drobecky3($_l, $_args) { extract($_args)
...
// block drobecky4
//
if (!function_exists($_l->blocks['drobecky4'][] = '_lbcb4a630e37_drobecky4')) { function _lbcb4a630e37_drobecky4($_l, $_args) { extract($_args)
;
}}
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb909fce04bd_content')) { function _lb909fce04bd_content($_l, $_args) { extract($_args)
?>
...
<?php Nette\Latte\Macros\CoreMacros::includeTemplate('detaval.latte', array('item' => $aval[$acena]) + $template->getParams(), $_l->templates['cw11558fxg'])->render() ?>
						</div>
<?php endif ?>
...
<?php if ($stab > 0): Nette\Latte\Macros\CoreMacros::includeTemplate('detaval.latte', array('item' => $aval[$acena]) + $template->getParams(), $_l->templates['cw11558fxg'])->render() ;endif ?>
		</div>
<?php endif ?>
...
<?php Nette\Latte\Macros\CoreMacros::includeTemplate('graph.latte', array('data_bar' => $data_bar) + $template->getParams(), $_l->templates['cw11558fxg'])->render() ?>
			</script>
...
// block title
//
if (!function_exists($_l->blocks['title'][] = '_lbefb42d558c_title')) { function _lbefb42d558c_title($_l, $_args) { extract($_args)
?>
