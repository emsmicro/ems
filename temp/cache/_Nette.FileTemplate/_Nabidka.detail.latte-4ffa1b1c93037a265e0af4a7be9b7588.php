<?php //netteCache[01]000393a:2:{s:4:"time";s:21:"0.38169600 1359280940";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:71:"C:\xamlite\htdocs\ems\app\modules\Obchod\templates\Nabidka\detail.latte";i:2;i:1359280935;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"f38d86f released on 2011-08-24";}}}?><?php

// source file: C:\xamlite\htdocs\ems\app\modules\Obchod\templates\Nabidka\detail.latte

?><?php list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'n59mb6426y')
;//
// block drobecky4
//
if (!function_exists($_l->blocks['drobecky4'][] = '_lb77f2b4a929_drobecky4')) { function _lb77f2b4a929_drobecky4($_l, $_args) { extract($_args)
...
// block drobecky5
//
if (!function_exists($_l->blocks['drobecky5'][] = '_lbb5da2e0ce2_drobecky5')) { function _lbb5da2e0ce2_drobecky5($_l, $_args) { extract($_args)
;
}}
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbc7828e6731_content')) { function _lbc7828e6731_content($_l, $_args) { extract($_args)
?>
...
<?php if ($user->isAllowed('Produkt','viewPrices')): ?>
	<div class="clear">
		<div class="kol-2">
			<h3>Ceny produktů</h3>
			<div>
<?php Nette\Latte\Macros\CoreMacros::includeTemplate('prices.latte', $template->getParams(), $_l->templates['n59mb6426y'])->render() ?>
			</div>
		</div>
	</div>
<?php endif ?>
...
// block title
//
if (!function_exists($_l->blocks['title'][] = '_lbf7dbd7377b_title')) { function _lbf7dbd7377b_title($_l, $_args) { extract($_args)
?>
