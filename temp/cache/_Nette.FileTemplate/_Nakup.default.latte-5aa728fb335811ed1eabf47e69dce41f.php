<?php //netteCache[01]000389a:2:{s:4:"time";s:21:"0.18312500 1382281605";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:67:"C:\xampp\htdocs\ems\app\modules\Nakup\templates\Nakup\default.latte";i:2;i:1323273112;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"f38d86f released on 2011-08-24";}}}?><?php

// source file: C:\xampp\htdocs\ems\app\modules\Nakup\templates\Nakup\default.latte

?><?php list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'nets95gky1')
;//
// block drobecky2
//
if (!function_exists($_l->blocks['drobecky2'][] = '_lb6fa9f88286_drobecky2')) { function _lb6fa9f88286_drobecky2($_l, $_args) { extract($_args)
...
// block drobecky3
//
if (!function_exists($_l->blocks['drobecky3'][] = '_lb169271e6c4_drobecky3')) { function _lb169271e6c4_drobecky3($_l, $_args) { extract($_args)
;
}}
...
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb2f54a7f09d_content')) { function _lb2f54a7f09d_content($_l, $_args) { extract($_args)
...
<div class="kolaps">
	<div >
		<div class="kol-1">
			...
			<div>
<?php Nette\Latte\Macros\CoreMacros::includeTemplate('../../../Obchod/templates/Produkt/prods_list.latte', array('products' => $nezapocate) + $template->getParams(), $_l->templates['nets95gky1'])->render() ?>
			</div>
		</div>
		<div class="kol-2">
			<h3>Produkty, u kterých nebylo dokončeno ocenění</h3>
			<div>
<?php Nette\Latte\Macros\CoreMacros::includeTemplate('../../../Obchod/templates/Produkt/prods_list.latte', array('products' => $neocenene) + $template->getParams(), $_l->templates['nets95gky1'])->render() ?>
			</div>
		</div>
	</div>
...
// block title
//
if (!function_exists($_l->blocks['title'][] = '_lb810ea5f984_title')) { function _lb810ea5f984_title($_l, $_args) { extract($_args)
?>
...
// block todolist
//
if (!function_exists($_l->blocks['todolist'][] = '_lb641ef7fdb4_todolist')) { function _lb641ef7fdb4_todolist($_l, $_args) { extract($_args)
